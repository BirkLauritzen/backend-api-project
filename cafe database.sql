...
INSERT INTO users (users_id, firstName, lastName, username, hashed_password) VALUES
                                                                                 (1, 'John', 'Doe', 'johndoe', 'hashedpassword1'),
                                                                                 (2, 'Alice', 'Smith', 'alicesmith', 'hashedpassword2'),
                                                                                 (3, 'Bob', 'Johnson', 'bobjohnson', 'hashedpassword3'),
                                                                                 (4, 'Emily', 'Williams', 'emilywilliams', 'hashedpassword4'),
                                                                                 (5, 'Michael', 'Jones', 'michaeljones', 'hashedpassword5'),
                                                                                 (6, 'Sophia', 'Brown', 'sophiabrown', 'hashedpassword6'),
                                                                                 (7, 'Daniel', 'Taylor', 'danieltaylor', 'hashedpassword7'),
                                                                                 (8, 'Olivia', 'Miller', 'oliviamiller', 'hashedpassword8'),
                                                                                 (9, 'David', 'Anderson', 'davidanderson', 'hashedpassword9'),
                                                                                 (10, 'Emma', 'Davis', 'emmadavis', 'hashedpassword10');
